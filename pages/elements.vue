            ...
            <ul id="menu-menu-1" class="menu">
              ...
              <li>
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <NuxtLink to="/portfolio-category">Portfolio Category</NuxtLink>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <main id="main" class="site-main" role="main">
            <article id="post-37" class="post-37 page type-page status-publish hentry">
              ...
              <div class="entry-content">
                <p>Here are some of the elements you can use with Moschino theme:</p>
                <p>
                ...
                <div class="wpcmsdev-accordion">
                  <div class="accordion-item">
                    <h3 class="accordion-item-title">
                      <NuxtLink to="#accordion-item-what-is-lore-ipsum"
                  ...
                  <div class="accordion-item">
                    <h3 class="accordion-item-title">
                      <NuxtLink to="#accordion-item-where-does-it-come-from"
                        ><i class="fa fa-plus icon-for-inactive"></i
                        ><i class="fa fa-minus icon-for-active"></i>Where does it come
                        from</NuxtLink
                      >
                    </h3>
                    <div
                  ...
                  <div class="accordion-item">
                    <h3 class="accordion-item-title">
                      <NuxtLink to="#accordion-item-why-do-we-use-it"
                        ><i class="fa fa-plus icon-for-inactive"></i
                        ><i class="fa fa-minus icon-for-active"></i>Why do we use
                        it</NuxtLink
                      >
                    </h3>
                    <div
                ...
                <p>
                  <NuxtLink class="wpcmsdev-button color-red" to="#"
                    ><span>Button Text</span></NuxtLink
                  ><NuxtLink class="wpcmsdev-button color-green" to="#"
                    ><span>Button Text</span></NuxtLink
                  ><NuxtLink class="wpcmsdev-button color-yellow" to="#"
                    ><span>Button Text</span></NuxtLink
                  ><NuxtLink class="wpcmsdev-button color-blue" to="#"
                    ><span>Button Text</span></NuxtLink
                  >
                </p>
                <p>
                ...
                <div class="wpcmsdev-tabs">
                  ...
                  <div class="tab">
                    <h3 class="tab-title" data-tab-id="where-does-it-come-from">
                ...
                <div class="wpcmsdev-toggle">
                  <h3 class="toggle-title">
                    <NuxtLink to="#toggle-what-is-lore-ipsum"
                      ><i class="fa fa-plus icon-for-inactive"></i
                      ><i class="fa fa-minus icon-for-active"></i>WHAT IS LORE
                      IPSUM</NuxtLink
                    >
                ...
                <div class="wpcmsdev-toggle">
                  <h3 class="toggle-title">
                    <NuxtLink to="#toggle-where-does-it-come-from"
                      ><i class="fa fa-plus icon-for-inactive"></i
                      ><i class="fa fa-minus icon-for-active"></i>WHERE DOES IT COME
                      FROM</NuxtLink
                    >
                ...
                <div class="wpcmsdev-toggle">
                  <h3 class="toggle-title">
                    <NuxtLink to="#toggle-why-do-we-use-it"
                      ><i class="fa fa-plus icon-for-inactive"></i
                      ><i class="fa fa-minus icon-for-active"></i>WHY DO WE USE IT</NuxtLink
                    >
                  </h3>
                ...
                <div class="wpcmsdev-columns">
                  <div class="column column-width-one-third">
                    <p>
                      ...
                      dignissim massa, vel pulvinar est. Nullam euismod massa et interdum
                      faucibus. Integer ut interdum est, a mollis nisi. Phasellus vitae
                      aliquam justo. Sed facilisis aliquet elit ut suscipit. Cras sed
                      dignissim enim.
                    </p>
                  </div>
                  <div class="column column-width-one-third">
                ...
                <div class="wpcmsdev-columns">
                  ...
                  <div class="column column-width-one-third">
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eget
                      dignissim massa, vel pulvinar est. Nullam euismod massa.
                    </p>
                  </div>
                </div>
                <hr />
                ...
                <p>
                  All icons from the
                  <NuxtLink
                    to="https://fortawesome.github.io/Font-Awesome/icons/"
                    target="_blank"
                    >FontAwesome list</NuxtLink
                  >
                  are supported.
                </p>
                <p>
                  <i class="fa fa-star fa-lg"></i><i class="fa fa-star fa-2x"></i
                  ><i class="fa fa-star fa-3x"></i><i class="fa fa-star fa-4x"></i
                  ><i class="fa fa-star fa-5x"></i>
                </p>
                <h4>
                  <i class="fa fa-heart" style="color: red"></i> We hope you love Moschino
